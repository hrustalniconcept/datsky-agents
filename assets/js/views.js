...
(function () {
  ...
  function home() {
    ...
    return sec(
      ...
      '<p class="lead">«Хрустальный парк» — малоэтажный микрорайон на Байкальском тракте: девять кварталов, каждый в архитектуре своей страны, около трёх тысяч жителей. Датский — девятый и последний, сдан в декабре 2025-го.</p>' +
    ...
    sec(
      ...
      '<p class="lead">Клиент въезжает не на пустую улицу, а в готовую среду: около трёх тысяч соседей, работающие кафе и садик, праздники во дворах по выходным. Это и есть главное отличие от коттеджного посёлка на том же тракте.</p>' +
      '<div class="grid g4">' +
