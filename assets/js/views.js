...
(function () {
  ...
  function home() {
    ...
    return sec(
      ...
      '<p class="lead">«Хрустальный парк» — малоэтажный микрорайон на Байкальском тракте: девять кварталов, каждый в архитектуре своей страны, больше трёх тысяч жителей. Датский — девятый и последний, сдан в декабре 2025-го.</p>' +
      '<p class="lead">Здесь центральные сети, уличное освещение, улицы до 9,5 метра и магазин в трёх минутах пешком — при том что до леса сто метров, а до залива пятьсот. Загородная жизнь без загородного быта.</p>' +
    ...
    sec(
      ...
      '<p class="lead">Клиент въезжает не на пустую улицу, а в готовую среду: больше трёх тысяч соседей, работающие кафе и садик, праздники во дворах по выходным. Это и есть главное отличие от коттеджного посёлка на том же тракте.</p>' +
      '<div class="grid g4">' +
      ...
      '<div class="card"><h4>Парковок вдвое больше нормы</h4><p class="small" style="margin:0">Коэффициент 1,6 машиноместа на квартиру против городских нормативов вдвое ниже. Проезды до 9,5 метра, а во дворе машин нет совсем.</p></div>' +
