...
(function () {
  ...
  function home() {
    ...
    var kozyri = [
      ...
      ['Два санузла с 63 метров', 'На рынке второй санузел появляется от восьмидесяти. Звучит мелочью ровно до того утра, когда четверо собираются одновременно.'],
      ['Терраса от 12 м²', 'Пятнадцать террас третьих этажей — весь видовой ресурс квартала, больше таких не будет. В договоре терраса идёт с коэффициентом 0,3: клиент платит примерно за треть, а пользуется целиком.'],
    ...
    return sec(
      ...
      '<h1>Другой формат жизни. И продаётся он иначе</h1>' +
      '<p class="lead">«Хрустальный парк» — 291 тысяча квадратных метров малоэтажки на Байкальском тракте. Девять кварталов, каждый в архитектуре своей страны, примерно восемь тысяч жителей. Датский — девятый и последний, сдан в декабре 2025-го.</p>' +
      '<p class="lead">Здесь центральные сети, асфальт, уличное освещение и магазин в трёх минутах пешком — при том что до леса сто метров, а до залива пятьсот. Загородная жизнь без загородного быта.</p>' +
      '<p class="lead">Для вас это значит вот что: такую квартиру не продать одной строчкой в объявлении. Зато когда клиент приезжает и видит двор без машин, террасу и живущих соседей, решение принимается быстро. Ваша комиссия — 4,5% от цены договора, до 768 тысяч с одной сделки.</p>' +
    ...
    sec(
      ...
      '<h2>Квартал — это девятая часть большого микрорайона</h2>' +
      '<p class="lead">Клиент покупает не дом на отшибе. Он въезжает в готовую среду, где уже живут около восьми тысяч человек, работают кафе и садик, а по выходным во дворах проходят праздники. Это и есть главное отличие от любого коттеджного посёлка на том же тракте.</p>' +
      '<div class="grid g4">' +
      '<div class="card"><h4>Девять кварталов</h4><p class="small" style="margin:0">Французский, Итальянский, Испанский, Чешский, Финский, Австрийский, Vila и Датский. У каждого свой двор и своё наполнение, а гуляют жители по всем сразу.</p></div>' +
      '<div class="card"><h4>Двор без машин</h4><p class="small" style="margin:0">Парковка вынесена по периметру, 107 мест. Проезды 7,5 и 9,5 метра — разъезжаться ни с кем не нужно.</p></div>' +
      '<div class="card"><h4>60% под зелень</h4><p class="small" style="margin:0">Озеленение и благоустройство занимают больше половины территории микрорайона.</p></div>' +
      '<div class="card"><h4>Больше 30 событий в год</h4><p class="small" style="margin:0">Масленица, Пасхальный квест, детская ярмарка, ХП-ФЕСТ на 250 гостей, общий новогодний салют. Традиции, а не разовые акции.</p></div>' +
      '</div>' +
